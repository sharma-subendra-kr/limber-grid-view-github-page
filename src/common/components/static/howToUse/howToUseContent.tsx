	...
	return (
		<div className={className}>
			...
			<p>
				...
				the viewport height. Also, the dimensions must not be tiny.
			</p>
			<p>Captain, Haddock: Hmmm...</p>
			<p>
				Tintin: Captain. Notice the latch feature is on. When you try to resize
				any item, LimberGridView will try to match the top-right, bottom-right,
				or bottom-left position of the nearest other items.
			</p>
			...
			<p>
				...
				Whether you like to place your item where the overlapped item exists or
				to latch your selected item to the nearest items. Just move your mouse
				or your finger over the box to toggle, and when you're done, release
				your mouse button or release your finger from the screen.
			</p>
			...
			<p>Captain, Haddock: I can't latch this Sea gherkin to this Sealion!!!</p>
			<p>
				Tintin: Look at the toolbar Captain, you have disabled the latch
				feature. Captain, use the latch feature 90% percent of the time. It will
				arrange your items properly. Sometimes it will not give you your desired
				result but, it works 85% of the time.
			</p>
